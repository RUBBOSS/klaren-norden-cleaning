      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Haben Sie Fragen zu unseren Reinigungsdienstleistungen? Wir sind
            hier, um Ihnen zu helfen. Senden Sie uns eine Nachricht und wir
          ...
          <div className="space-y-8">
            ...
            <div className="bg-blue-50 rounded-lg p-6">
              ...
              <p className="text-gray-600">
                Wir antworten normalerweise innerhalb von 24 Stunden auf alle
                Anfragen. Für dringende Anliegen rufen Sie uns bitte direkt an.
              </p>
            </div>
          </div>
        </div>
